...
class Local_Global_Network(nn.Module):
    def __init__(self,node_size,rel_size,triple_size,node_dim,
                 depth=2,attn_heads=1,attn_heads_reduction='concat',use_bias=False):
        super(Local_Global_Network, self).__init__()
    ...
    def forward(self, inputs):
        ...
        str_outputs = torch.cat(outputs, dim=-1)
